 ...
 */
public class HR35_JavaReflectionAttributes {
    public static void main(String[] args) {
        Class student3 = Student3.class;
        Method[] methods = student3.getDeclaredMethods();

        ArrayList<String> methodList = new ArrayList<>();
        for (Method w : methods) {
            methodList.add(w.getName());
        }

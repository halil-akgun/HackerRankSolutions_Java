 ...
 */
public class HR41_CanYouAccess {
    public static void main(String[] args) throws Exception {
//        DoNotTerminate.forbidExit();     // SecurityManager is deprecated and marked for removal
        ...
        try {
            ...
            Object o2 = new Inner().new Private().powerof2(num);
            System.out.println(num + " is " + o2);
...
//    public static void forbidExit() {     // SecurityManager is deprecated and marked for removal
